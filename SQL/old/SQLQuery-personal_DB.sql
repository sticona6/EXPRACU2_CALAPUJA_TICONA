create database personal_DB go
...
( 
	id_asignacion_escolar char(18)  NOT NULL ,
...
( 
	...
	id_tipo_pago_prestamo char(18)  NULL ,
	id_personal          int  NULL 
)
go
...
( 
	...
	id_tipo_pago_prestamo char(18)  NOT NULL 
)
go
...
ALTER TABLE Personal
	ADD CONSTRAINT R_17 FOREIGN KEY (id_horario) REFERENCES Control_Horario(id_horario)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
